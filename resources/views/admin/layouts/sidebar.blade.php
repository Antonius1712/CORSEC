        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item">
                <a href="{{ Route('home') }}">
                    ...
                    <span class="menu-title" data-i18n="User Page">User Page</span>
                </a>
            </li>
            <li class=" nav-item">
                <a href="index.html">
                ...
                <ul class="menu-content">
                    <li class="{{ Request()->segment(3) == 'master-document' ? 'active' : '' }}">
                        <a href="{{ Route('admin.sipedas.master-document.index') }}">
                            <i class="feather icon-circle"></i>
                            <span class="menu-item" data-i18n="Master Document">Master Document</span>
                        </a>
                    </li>
                    <li class="{{ Request()->segment(3) == 'document' ? 'active' : '' }}">
                        <a href="{{ Route('admin.sipedas.document.index') }}">
                            <i class="feather icon-circle"></i>
